...
``` bash
nohup /apps/element/bases2fastq --num-threads 16 --group-fastq --legacy-fastq --run-manifest RunManifest.csv /mnt/new_home/element/AV240301/20250131_AV240301_SARSDIAGNOSIS/ 2025_05_21_ERIC_study/ > ./2025_05_21_ERIC_study.log 2>&1 &
```
...
``` bash
rsync -r 2025_05_21_ERIC_study /mnt/new_home/stamatopoulos_research
```
