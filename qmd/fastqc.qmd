...
``` bash
wget https://raw.githubusercontent.com/natanast/RNAseq_analysis/main/bash/fastqc.sh
```

``` bash
wget https://raw.githubusercontent.com/natanast/RNAseq_analysis/main/bash/runFASTQC.sh 
```
...
``` bash
nohup bash runSTAR.sh /mnt/new_home/stamatopoulos_research/RNAseq_2025_05_21 SampleList 16 &
```
